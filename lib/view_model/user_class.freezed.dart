...
class _$UserTearOff {
  ...
  _User call({required int id, bool isImportant = true}) {
    return _User(
      id: id,
...
class _$_User implements _User {
  const _$_User({required this.id, this.isImportant = true});
  ...
  @override
  String toString() {
    return 'User(id: $id, isImportant: $isImportant)';
  }
...
abstract class _User implements User {
  const factory _User({required int id, bool isImportant}) = _$_User;
